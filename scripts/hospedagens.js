...
function villa(){
    ...
    Aninhada nas praias ensolaradas perto da charmosa vila de pescadores de Maracajaú, 
    nossa vila é um refúgio de tranquilidade. Aqui, dunas de areia infinitas encontram 
    as águas cristalinas de recifes de corais protegidos, criando um playground para aventuras. 
    Mergulhe com snorkel em meio à vibrante vida marinha, explore as dunas em um emocionante passeio de quadriciclo 
    ou simplesmente perca-se nos quilômetros de praia intocada.
    Dentro de um condomínio fechado e privativo - que já foi uma próspera plantação de coco -  
    encontra-se o seu paraíso pessoal. Situada em uma extensa propriedade de 5.000 m², a vila é cercada 
...
function oasis(){
    ...
    Nosso Kitesurf Oasis possui dois quartos duplos e duas suítes luxuosas na villa. 
    Além de outros dois quartos duplos exclusivos no chalé. Todos os quartos têm ar condicionado e são de última geração. 
    Atribuímos grande importância à qualidade e limpeza. 
    No jardim você encontrará diversas plantas tropicais e árvores frutíferas que ocasionalmente convidam macaquinhos ou iguanas 
    a passar por aqui.Temos um restaurante no edifício principal onde a nossa chef Laila prepara iguarias locais 
    e também pratos internacionais. Existe também um spa de massagens nas nossas instalações, 
    para que nada falte depois de um dia cansativo na água. Há também uma confortável plataforma de observação 
